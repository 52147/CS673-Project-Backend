...
def init_model(device,model_path):
    ...
    cfg = check_point['cfg']
    model = PlateNetv1(num_classes=len(plate_chr), export=True, cfg=cfg)        #export  True 用来推理
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', type=str, default='images/cutout.png', help='source')
